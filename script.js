...
//api key and url
const apiKey = "ea1bfd57be56c4955ef4bc163ea614a7";
...
//for featching the data of city and api
async function checkWeather(city) {
    const response = await fetch (apiUrl + city + `&appid=${apiKey}`);
    var data = await response.json();
    
    //for changing the name of city and temperatureetc 
